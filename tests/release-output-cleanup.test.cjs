    ...
    const fixtures = [
      {
        ...
        version: "0.20.6",
        current: ["creator-workflow-toolkit-personal-v0.20.6.zip"],
      ...
      },
      {
        family: "DesktopStage",
        version: "0.20.6",
        current: ["ofenhancer-desktop-v0.20.6"],
      ...
      },
      {
        ...
        version: "0.20.6",
        current: ["OFEnhancer-Setup-0.20.6.exe"],
      ...
      },
      {
        ...
        version: "0.20.6",
        current: [
          "x-teaser-native-host-v0.20.6",
          "x-teaser-native-host-v0.20.6.zip",
        ],
        stale: [
