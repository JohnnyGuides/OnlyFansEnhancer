...
test("upload console chooses the next Friday at 15:00 UTC", () => {
  ...
  assert.equal(
    hooks.nextFridayLocalValue(new Date("2026-08-21T14:59:00Z")),
    "2026-08-21T17:00",
  );
  assert.equal(
    hooks.nextFridayLocalValue(new Date("2026-08-21T15:00:00Z")),
    "2026-08-28T17:00",
  );
});
