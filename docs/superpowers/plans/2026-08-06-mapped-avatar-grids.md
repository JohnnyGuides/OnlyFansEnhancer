...
- [ ] **Step 3: Implement the minimal sanitized view**
...
- [ ] **Step 4: Run the background test and verify GREEN**
...
- [ ] **Step 3: Implement the minimal atomic mutation**
...
- [ ] **Step 5: Run browser and personal tests and verify GREEN**
...
- [ ] **Step 1: Run all checks and builds**

Run: `npm run check`

Expected: lint, typecheck, format check, 19 or more tests, personal build, and store build all pass.

- [ ] **Step 2: Inspect the personal package**

Expand the generated v0.8.1 ZIP to a temporary folder and assert it contains the updated options files and no localhost scraper strings.
