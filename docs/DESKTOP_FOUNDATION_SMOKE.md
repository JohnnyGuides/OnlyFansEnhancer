...
This checklist verifies the current OFEnhancer 0.20.4 desktop candidate
...
`dist\ofenhancer-desktop-v0.20.4\`. `npm run build:desktop` compiles
`OFEnhancer-Setup-0.20.4.exe` only when Inno Setup 6 is installed. A successful
